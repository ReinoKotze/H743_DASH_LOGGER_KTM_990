...
/*
nonblocking conversion state machine that uses blocking I²C transfers

It starts a conversion, returns, and checks for the result on later calls.
only blocks on i2c bus problems 
*/
